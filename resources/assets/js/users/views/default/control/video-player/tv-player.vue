<template>
    <div class="wolf-player">
        ...
        <div class="col-12 col-md-8 offset-md-2 mt-5" v-if="!spinner_load">
            <div class="jw-player">
                <div class="jwplayer-loader"
                     style="text-align: center;height: 70vh; background: #1d1d1d; position:relative;" v-if="loadPlayer">
                    <loader style="
                        position: absolute;
                        top: 50%;
                        left: 50%;
            ...
            <div class="episode-list mb-5">
                <carousel class="list-carousel" navigationPrevLabel='<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 129 129" enable-background="new 0 0 129 129" width="100%" class="arrow-right-svg"><g><g>
                    ...
                    <slide v-for="(item,index) in data.suggestions" :key="index" class="col-6 col-md-4 col-lg-3 col-xl-2 m-2 animation ">

                        <div class="episode" @click="CHANGE_CHANNEL(item)" style="cursor: pointer;">
                            <progressive-img :src="'/storage/posters/' + item.image" :alt="item.name" width="100%" :blur="1"/>
